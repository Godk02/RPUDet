...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if cuda and RANK == -1 and torch.cuda.device_count() > 1:
        ...
        #model = BalancedDataParallel(1, model, dim=0)
    ...
    #         find_unused_parameters=True  # 添加以防止参数未使用报错
    #     )
...
def parse_opt(known=False):
    ...
    parser.add_argument('--resume', nargs='?', const=True, default=False, help='resume most recent training')#############################断点
